L.Control.OpacitySlider=L.Control.extend({includes:L.Evented?L.Evented.prototype:L.Mixin.Events,options:{position:"topright",opacity:100,backgroundColor:"transparent",sliderImageUrl:"images/opacity-slider3d14.png",margin:5},_OPACITY_MAX_PIXELS:57,initialize:function(layer,options){L.Util.setOptions(this,options);this.overlay=layer},onAdd:function(map){var slider=L.DomUtil.create("DIV","opacity-slider");slider.setAttribute("style","margin:"+this.options.margin+"px;overflow-x:hidden;overflow-y:hidden;background:url("+
